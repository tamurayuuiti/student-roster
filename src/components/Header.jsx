    ...
    <header className="bg-(--color-white) shadow-(--shadow-header) mb-(--spacing-v-xl) md:mb-6 p-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <a href="#" className="text-2xl font-bold text-gray-900 tracking-wide no-underline">
            3学年名簿
          </a>
          ...
          <div className="relative flex items-center gap-(--spacing-v-md) bg-transparent border-0 shadow-none p-0">
            ...
            <div
              ...
              className={`
                ...
                bg-(--color-white) border border-gray-200 rounded-xl shadow-xl z-30
                origin-top-right transition-all duration-200 ease-out motion-reduce:transition-none
                ${
                  menuState === "open"
